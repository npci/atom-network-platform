...
import { formatTime } from '../../lib/certStatus'
...
// 24-hour, to the millisecond — a log viewer wants a sortable, unambiguous
// clock, so hour12 stays pinned off. Everything else (separator, digit shape)
// follows the viewer's own locale.
