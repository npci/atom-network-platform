...
import { relativeTime, formatDate, DASHBOARD_ROW_STATUS, isStalledByActivity } from '../../lib/certStatus'
      ...
      <KpiStrip
        ...
        tiles={[
          ...
          },
          {
            ...
            sub:   (totals.awaiting_go_live || 0) > 0 ? `${authorityLabel} ops to mark live` : 'none pending',
            color: 'var(--success)',
          },
          {
            label: 'Active cert',
