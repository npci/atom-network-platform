...
export default function XSD() {
  ...
  // Agentic Phase A: when the change opts into the agentic engine,
  ...
  // assumed to be the payment network's core+app pair. See utils/repoTopology.js.
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: 'calc(100vh - 0px)', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '24px' }}>
        ...
        {/* Agentic Phase A: generate the XSD edits in the repo,
