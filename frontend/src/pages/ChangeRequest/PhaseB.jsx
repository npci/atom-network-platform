      ...
      <div style={{ padding: '16px 20px' }}>
        ...
        {running && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '20px', justifyContent: 'center' }}>
            ...
            <span style={{ fontSize: '13px', color: 'var(--text-muted)' }}>Analysing code against {isCode ? 'SonarQube + PMD rules' : 'OWASP Top 10 + the ecosystem security standards'}…</span>
          </div>
        )}
...
export default function PhaseB() {
  ...
  // Agentic Phase B: when the change opts into the agentic engine,
  ...
  // ── Agentic Phase B — focused view, bypasses the legacy pipeline
