...
- 🧾 **Externalised prompts** in `app/prompts/` — 73 prompts live as `.md` files, loaded rather than hardcoded
...
alembic/versions/  Migrations (head: 0141)
...
|---|---|---|
| `LLM_PROVIDER` | `anthropic` | `anthropic` \| `openai` \| `gemini` \| `ainxt` \| `ollama`; `claude` is a back-compat alias |
...
- [`../CONTRIBUTING.md`](../CONTRIBUTING.md) — conventions and the gotcha index
