...
def rerank(query: str, candidates: list[dict], top_k: int) -> list[dict]:
    ...
    Two cheap optimisations layered on top:
    ...
    # Early-exit on too-few candidates. Generalises the original
    ...
    # Score cache hit short-circuits the backend call entirely.
