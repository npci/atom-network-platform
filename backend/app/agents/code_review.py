...
Analyses Java source files against SonarQube + PMD rule sets using the configured LLM.
  ...
  "issues": [
    {
      ...
      "severity": "major",
      "file": "com/example/network/service/OrderService.java",
      "line": 42,
      "message": "Method processOrder has cyclomatic complexity of 15 (threshold: 10)",
