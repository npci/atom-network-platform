...
"""Shared citation-enforcement helpers.

Citation enforcement started on the deep_researcher agent
only. These helpers replicate the pattern for BRD / Tech Spec / Canvas — three
