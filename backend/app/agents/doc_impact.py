...
"""Doc-impact agent — does the Authority's reply imply a Product Kit document change?

Step 5 of the negotiation protocol: after the Authority decides how to answer a partner
...
which regenerates the affected docs into the next kit version.
...
# Under the default network pack these render byte-identically to the previous
# hardcoded prompt.
