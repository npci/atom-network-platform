...
ecosystem's vocabulary — FRs had to begin "The Authority shall" / "The Partner must",
diagrams showed one ecosystem's fixed actor list, API names were
"ReqTransfer, RespTransfer" —
...
# The product canvas's "Product Operating" bullets. The list this replaced named
# SGF (Settlement Guarantee Fund) and FRM (Fraud Risk Management) — one
# authority's internal functions — as REQUIRED content of every product doc in
# every domain. The default asks for the operating concerns any product has; a
# domain with its own named functions declares them in its pack.
_CANVAS_PRODUCT_OPERATING = _PB(
    "canvas_product_operating_bullets",
    "3 Success KPIs, Support/escalation, Day 0 automation, "
...
BRD_BLUEPRINT: Blueprint = {
    ...
    "sections": [
        ...
        {"key": "security_privacy", "heading": "9. Security & Data Privacy",
         "instructions": "Regulatory and data-protection compliance, data flows, encryption, abuse/misuse risk mitigations.",
         "min_paragraphs": 2, "required": True},
...
TECH_SPEC_BLUEPRINT: Blueprint = {
    ...
    "sections": [
        ...
        {"key": "security", "heading": "7. Security Design",
         "instructions": "Encryption (in-transit, at-rest), key management, cert pinning, abuse-detection hooks.",
         "min_paragraphs": 2, "required": True},
...
CANVAS_BLUEPRINT: Blueprint = {
    ...
    "sections": [
        ...
        {"key": "product_operating", "heading": "6. Product Operating",
         "instructions": "Bullets for: " + _CANVAS_PRODUCT_OPERATING,
         "required": True},
        ...
        {"key": "risks", "heading": "9. Potential Risks",
         "instructions": "Bullets for: Abuse/misuse, Infosec, Legal, Data privacy, 2nd-order effects.",
         "required": True},
