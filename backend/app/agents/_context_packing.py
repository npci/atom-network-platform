...
Part of the indexing/retrieval implementation plan.
...
class PackedContext:
    ...
    as Anthropic-style `system=[{type:"text", ...}]`. For now
    we always emit a string and leave the segmented form to a later change.
    """
    system: str
    messages: list[dict]
    prompt_tokens: int
...
# Counters — surfaced via observability metrics.
