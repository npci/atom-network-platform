...
_SYSTEM_PROMPT = """You are an ADVERSARIAL code reviewer working on
production infrastructure. Your job is to find what the primary reviewer
...
async def review_adversarially(
    ...
    *,
    ...
    Args:
        ...
        code_plan: Optional CodePlan dict — informs the reviewer
