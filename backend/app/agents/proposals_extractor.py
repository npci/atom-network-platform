...
into their prompts so the LLM works from the network's real names/patterns instead
...
# (registry pattern). Under the default network pack the assembled system template
...
# ──────────────────────────────────────────────────────────────────────────────
# System prompt — mixes the taxonomy-specific required_fields and the domain hard
...
async def extract_proposals(
    ...
    # proposals_extractor is Purpose.ROUTING (structured-extract
