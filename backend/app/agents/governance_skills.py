...
Accepts the portable SKILL.md shape used by coding agents (
...
# Generic level-2 section heading (the portable SKILL.md shape —
...
def parse_skill(content: str) -> dict:
    ...
    Mode 2 — ``sections``: the portable SKILL.md shape (
