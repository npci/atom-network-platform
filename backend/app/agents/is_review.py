...
Analyses Java source files against OWASP Top 10 and the Authority's security standards.
...
# For the network pack the assembled prompt is byte-identical to the previous hardcoded
