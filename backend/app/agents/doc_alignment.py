...
_EXTRACT_SYSTEM = (
    ...
    "  - actor duties (what each participant and the Authority must do)\n"
...
_ALIGN_SYSTEM = (
    ...
    "      actor_conflict: same step, different responsible party (one participant vs another vs the Authority)\n"
