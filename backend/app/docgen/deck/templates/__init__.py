...
"""Layout builders + the generated `deck_master.pptx` reference deck.
...
`deck_master.pptx`, a reference deck that:
...
The renderer does NOT load `deck_master.pptx` at runtime; it calls
