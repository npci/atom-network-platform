...
#      We drop the engine cost ledger and let the host meter.
#
...
async def node_strategy(state: GraphState) -> dict[str, Any]:
    """Synthesise + persist the CertificationStrategy.
...
def _build_uncompiled() -> StateGraph:
    ...
    # Deterministic synthesis + artifact persist. Sits between
