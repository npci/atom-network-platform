...
"""The certification trigger, AUTHORITY side.
...
true of this platform's own application as of the partner's:
    ...
    ──────────────────────────────────────────────────────────────
    partner    partner-sim control API    certification trigger
    authority  precert / pack-sim         **certification trigger**  ← this module
