...
This is the forward direction's near end. A Simulator points at this
...
* **It does not retry.** A tunnelled POST is a business call on the far side;
  ...
  from these task types for the same reason.
"""
...
async def forward_exchange(
    *,
    ...
    # so this keeps working once the wrapping becomes structured.
