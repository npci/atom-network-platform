...
def update_job(
    ...
    *,
    ...
    if current_stage is not None:
        # Error-message exposure (CWE-209): `current_stage` is serialised by AgentJob.to_dict() and
...
def complete_job(
    ...
    *,
    ...
    job.updated_at = now
    # Error-message exposure (CWE-209): same client-visible field as in update_job. A success path is the
...
def fail_job(
    ...
    *,
    ...
    Information Exposure Through an Error Message (CWE-209): `error_message` is
