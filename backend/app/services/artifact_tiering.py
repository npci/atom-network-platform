...
Closes "No Data Tiering for Large Payloads".
...
def mark_ready_for_archive(db: Session) -> dict:
    ...
    (outside this codebase, per the phased plan) should periodically query
...
# C4 of the review closure: "the original content/payload
