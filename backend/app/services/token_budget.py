...
Frontier models support 200k+ input tokens but (a) cost scales linearly and
...
# 1 token ≈ 4 chars. Slightly conservative (most tokenizers are closer to 3.5-4).
_CHARS_PER_TOKEN = 4.0

# Default input budget. Well below a 200k context to leave room for:
