...
Expressed once in the pack, executed by one engine on both sides: a participant
that fails at the simulator and one that fails at the grader fail for the same
