...
The partner platform's card (in its own repository) will list a
...
def _card_name() -> str:
    ...
    block ("the Network Change Management Platform" — the leading article is
    ...
    "mtls": SecurityScheme(
        mtls_security_scheme=MutualTlsSecurityScheme(
            description=(
                ...
                "for mTLS-tier partners (`tls_tier='mtls'`). The cert's "
...
AUTHORITY_AGENT_CARD = AgentCard(
    ...
    skills=[
        AgentSkill(
            ...
            description=(
                "Outbound from the Authority to partner — registered here so "
                "partners can verify the Authority's role in their card discovery."
            ),
        ...
        AgentSkill(
            ...
            description=(
                "Partner asks the Authority a question about a change. Data: "
                "{change_id, payload: {text}}. The Authority auto-drafts a "
        ...
        AgentSkill(
            ...
            description=(
                "Outbound from the Authority to partner. Listed for symmetry."
            ),
            tags=["change", "outbound"],
        ),
        AgentSkill(
        ...
        AgentSkill(
            ...
            description=(
                "Outbound from the Authority to a cert_engine partner. Listed "
                "for symmetry."
            ),
        ...
        AgentSkill(
            ...
            description=(
                "Outbound from the Authority to partner. Fires whenever a new "
                "negotiation round opens on the authority side (initial ack, PM "
        ...
        AgentSkill(
            ...
            description=(
                "Outbound from the Authority to partner. Fires whenever a "
                "negotiation round closes on the authority side. Data: {change_id, "
