...
Required extras:
    ...
    partner platform (SQLite):   `aiosqlite>=0.19`   in its own repository
...
This module ships only the factory + URL translation. Tests for the actual
Task lifecycle persistence land in a later change, once an Executor exists
to drive the store.
"""
