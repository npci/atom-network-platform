...
the property a hand-maintained prompt catalogue was only ever approximating.
...
THE TRAILING-NEWLINE RULE, which matters more than it looks:
    ...
    One byte is not cosmetic here. `core/prompt_blocks.segments_for_prompt_cache`
