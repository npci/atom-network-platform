...
"""Admin ACTION audit trail — closes threat-model finding T8.
...
before/after snapshot of the fields that changed. Satisfies the
"every important control decision... traceable" requirement for the
admin surface specifically,
which the MFA requirement (closed separately, see T7) does not by
