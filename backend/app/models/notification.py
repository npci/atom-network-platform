...
class NotificationType(str, enum.Enum):
    ...
    # outbound A2A message to a partner could not be delivered — previously that was
    # only a logger.error() nobody watched, so a partner silently never got its kit.
