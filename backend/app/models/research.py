...
class ResearchOutput(Base, TimestampMixin):
    ...
    # Renamed from `rbi_compliance` in alembic 0141. No application code reads
    # or writes this column — only `combined_report` is used.
    regulatory_compliance: Mapped[str | None] = mapped_column(Text, nullable=True)
