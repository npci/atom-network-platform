...
Closes "No Data Tiering for Large Payloads" — see
`app/services/artifact_tiering.py` for the compression
and archive-eligibility jobs that populate this table.
