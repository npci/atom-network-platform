...
def apply_test_cases(change_id: str, body: _ApplyBody, db: DbDep, user: AdminUser):
    ...
    for fr in body.flow_registrations:
        try:
            ...
            # Error-message exposure (CWE-209): `flow_results` is returned to the caller as
...
def get_sync_log(change_id: str, db: DbDep, _: AdminUser, limit: int = Query(50, ge=1, le=200)):
