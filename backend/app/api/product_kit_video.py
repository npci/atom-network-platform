...
from app.core.change_access import require_change_or_kit_access
...
router = APIRouter(tags=["product-kit-video"], dependencies=[Depends(require_change_or_kit_access)])
