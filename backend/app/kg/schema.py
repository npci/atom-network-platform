...
"""Apache AGE graph schema for the Authority knowledge graph.
    ...
    *,
    ...
    for label in NODE_LABELS:
        ...
        try:
            ...
            # Error-message exposure (CWE-209): `failures` is a declared field on KgInitResponse and is
    ...
    for label in EDGE_LABELS:
        ...
        try:
            ...
            # Error-message exposure (CWE-209): see the sibling handler above — same response field,
            # same SQL disclosure.
