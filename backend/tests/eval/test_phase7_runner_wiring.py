...
These verify that contracts and checks compose end-to-end and
that the wiring helper is safe from either kind of FastAPI handler.
"""
...
def _good_research() -> dict:
    return {
        ...
        "content": "the Authority procedures referenced in https://authority.example/specifications guide validation.",
    }
