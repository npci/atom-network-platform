...
"""Tests for the shared `build_impact_block` helper.

Verifies the extracted helper behaves identically to the code-change
agent's earlier inline version, plus thin coverage of BRD/Tech-Spec
wiring (db parameter accepted, impact section threaded into context).
"""
