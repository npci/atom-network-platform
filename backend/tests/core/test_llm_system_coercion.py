...
"""System-prompt coercion helpers in app.core.llm.
...
from app.core.llm import _coerce_system_to_str, _system_for_messages_api
...
def test_system_for_claude_string_stays_string():
    assert _system_for_messages_api("plain") == "plain"
...
def test_system_for_claude_list_passthrough_when_valid():
    ...
    out = _system_for_messages_api(segs)
