...
Found during the adversarial re-review of the information-exposure triage
(CWE-209). The original pass classified exception handlers by where the
exception appears *lexically*,
