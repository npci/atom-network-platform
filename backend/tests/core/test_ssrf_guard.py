...
# Found on a second, adversarial pass over the sensitive-data-in-logs findings
# (CWE-532), by asking what happens when the URL is MALFORMED rather than
