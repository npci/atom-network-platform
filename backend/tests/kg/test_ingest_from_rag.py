...
"""Tests for the RAG→AGE graph projection.
...
class TestExecutePlan:
    ...
    def test_exception_in_one_op_doesnt_stop_others(self):
        ...
        # CWE-209: `failures` is returned by POST /api/kg/ingest. A RuntimeError
    ...
    def test_failure_never_echoes_the_cypher_query(self):
        """CWE-209: `failures` is returned by POST /api/kg/ingest, so the
