...
Added while triaging a batch of sensitive-data-in-logs findings (CWE-532). No
scanner reported this one; it was found by reading the surrounding code.
...
def test_mask_username_shortens_and_obscures():
    ...
    for name in ("keyur.doshi", "priya.sharma@example.com", "administrator"):
