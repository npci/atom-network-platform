...
to hardcode the network's "exactly one core + one app" rule, which made a single-repo
...
the permissive single-repo default and the network loses its two-repo guardrail with no
