...
Asserts `app.services.change_communication_wire.to_wire_v1_1` produces the
shape the v1.1 A2A change-communication contract defines — canonical names, the
...
def test_business_fields_nullable():
    ...
    for field in (
        ...
        "authority_circular_ref", "rbi_reference", "simulator_available_from",
    ):
